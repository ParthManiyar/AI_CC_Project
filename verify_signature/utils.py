...
def Account_Number_Extraction(acc):
    ...
    for contour in cnts:
        ...
        if w>10 and w<40 and h>30 and h<60:
...
def Signature_Matching(sign1,sign2):
    user1_sigs  = [sign1,sign2]
    processed_user1_sigs_spp = [255-remove_background1(user1_sigs[0]),255-remove_background1(user1_sigs[1]) ]
